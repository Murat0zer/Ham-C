...
public class Parser implements ParserConstants {
  ...
  Token t; java.util.List parameterList; Stm s; String returnType;
    ...
    s = compoundStatement();
      {if (true) return new FunctionDeclaration(returnType, t.image, parameterList, s );}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public void structMemberDeclarations() throws ParseException {
    type();
    jj_consume_token(ID);
    jj_consume_token(SEMI);
    label_3:
  ...
  static final public StrConst simpleInitializer() throws ParseException {
  Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INTCONST:
  ...
  static final public void structInitializer() throws ParseException {
    initializer();
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public Stm compoundStatement() throws ParseException {
 Stm s1,s2;
    jj_consume_token(LBRACE);
    s1 = statementList();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public Stm statementList() throws ParseException {
 Stm s1;
    label_5:
    while (true) {
      s1 = statement();
  ...
  static final public Stm statement() throws ParseException {
 Stm stm;
    if (jj_2_3(2)) {
  ...
  static final public void expressionOrAssignmentStatement() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE:
    case FALSE:
    case LPAREN:
...
*/
  ...
  static final public void labelBlock() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CASE:
  ...
  static final public Stm printStatement() throws ParseException {
 Exp e; Token t;
  ...
  static final public Exp logicalOr() throws ParseException {
  Exp e1, e2;
    e1 = logicalAnd();
    label_7:
    while (true) {
      ...
      jj_consume_token(OR);
      e2 = logicalAnd();
                                      {if (true) return new LogicalOR(e1, e2);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }

  static final public Exp logicalAnd() throws ParseException {
  Exp e1, e2;
    ...
    while (true) {
      ...
      e2 = equalityExpression();
                                              {if (true) return new LogicalAND(e1, e2);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }

  static final public Exp equalityExpression() throws ParseException {
  Exp e1, e2; Token t;
    ...
    while (true) {
      ...
      e2 = relationalExpression();
                                          {if (true) return new EqualityExpression(e1, e2, t.image);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }

  static final public Exp relationalExpression() throws ParseException {
  Exp e1,e2; Token t;
    ...
    while (true) {
      ...
      e2 = additiveExpression();
                                        {if (true) return new RelationalExpression(e1, e2, t.image);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }
  ...
  Exp e1,e2; Token t;
    ...
    while (true) {
      ...
      e2 = multiplicativeExpression();
                                               {if (true) return new AdditiveExpression(e1, e2, t.image);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }
  ...
  Exp e1,e2; Token t;
    ...
    while (true) {
      ...
      e2 = exponentialExpression();
                                            {if (true) return new MultiplicativeExpression(e1, e2, t.image);}
    }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
  }
 ...
 Exp e1,e2; Token t;
    ...
    case LPAREN:
      ...
      e1 = expression();
      jj_consume_token(RPAREN);
                                                 {if (true) return new PrimaryExpression(e1);}
      break;
    case ID:
      t = jj_consume_token(ID);
      e1 = primaryExpressionPrime();
                                                    {if (true) return new PrimaryExpressionPrime(e1, t.image);}
      break;
    default:
      jj_la1[43] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public Exp primaryExpressionPrime() throws ParseException {
  Exp e1;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LPAREN:
      jj_consume_token(LPAREN);
  ...
  static final public Exp expressionList() throws ParseException {
  Exp e1, e2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TRUE:
    case FALSE:
    ...
    case STRCONST:
      ...
      while (true) {
        ...
        e2 = jj_consume_token(COMMA);
        expression();
      }
                                                           {if (true) return new ExpList(e1, e2);}
      break;
    default:
      jj_la1[46] = jj_gen;
      ;
  ...
  static final public Exp constantExpression() throws ParseException {
 Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INTCONST:
    ...
    case TRUE:
      t = jj_consume_token(TRUE);
                       {if (true) return new BNum(true);}
      break;
    case FALSE:
      t = jj_consume_token(FALSE);
                        {if (true) return new BNum(false);}
      break;
    case STRCONST:
      t = jj_consume_token(STRCONST);
                           {if (true) return new StrConst(t.image);}
 ...
 Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3e50000,0x3e10000,0x3e00000,0x3c00000,0x200000,0x0,0x40000,0x3c00000,0x40000,0x40180000,0x180000,0x0,0x40000000,0x441acf40,0x0,0x4180000,0x40000,0x0,0x840,0x80,0x3000,0x3000,0x47decf40,0x180000,0x4180000,0x4180000,0x4180000,0x700,0x4180000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4180000,0x10000000,0x10000000,0x4180000,0x4000000,0x0,0x4180000,0x180000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2000000,0x2000000,0x2000000,0x2000000,0x0,0x2,0x0,0x2000000,0x0,0x1c000000,0x1c000000,0x2,0x0,0x1e102031,0x400,0x1e002030,0x0,0x400,0x0,0x0,0x0,0x0,0x1e102031,0x1c000000,0x1e002030,0x1e002030,0x1e002030,0x0,0x1e002030,0x1000,0x800,0xc000,0xc000,0xf0000,0xf0000,0x30,0x30,0xc0,0xc0,0x200,0x1e002030,0x8,0x8,0x1e000000,0x0,0x2,0x1e002030,0x1c000000,0x2030,};
   }
