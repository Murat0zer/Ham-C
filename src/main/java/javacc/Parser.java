...
public class Parser implements ParserConstants {
  ...
  AbstractGlobalScopeUnit globalScopeUnit;
      if (jj_2_1(3)) {
        ...
        case STRING:
        case ID:
          globalScopeUnit = functionDefinition();
                                                 {if (true) return globalScopeUnit;}
          break;
        default:
          jj_la1[1] = jj_gen;
  ...
  static final public AbstractGlobalScopeUnit functionDefinition() throws ParseException {
  ...
  Token t; java.util.List parameterList; Statement body; String returnType;
      ...
      {if (true) return new FunctionDefinitionDefinition(returnType, t.image, parameterList, body );}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  Token t;
      ...
      case FALSE:
        jj_consume_token(FALSE);
                      {if (true) return new interpreter.ast.expression.logical.BoolExpression(false);}
        break;
      case STRCONST:
...
//}
  ...
  static final public Statement breakStatement() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(SEMI);
          {if (true) return new interpreter.ast.statement.flow_control.BreakStatement();}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  Expression e1, e2;
      ...
      while (true) {
        ...
        e2 = equalityExpression();
                                              e1 = new interpreter.ast.expression.logical.LogicalAND(e1, e2);
      }
          {if (true) return e1;}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  Expression e1,e2; Token t;
      ...
      while (true) {
        ...
        case MINUS:
          ...
          e2 = multiplicativeExpression();
                                                          e1 = new interpreter.ast.expression.arithmetic.additive.MinusExpression(e1, e2);
          break;
        default:
          jj_la1[38] = jj_gen;
          jj_consume_token(-1);
 ...
 Expression e1,e2; Token t = null; Expression primaryExpressionPrime = null;
      ...
      default:
        ...
        if (jj_2_19(3)) {
          t = jj_consume_token(ID);
          primaryExpressionPrime = primaryExpressionPrime();
         if(primaryExpressionPrime == null)
             {if (true) return new IdExpression(t.image);}
         else
            {if (true) return new FunctionCall(t.image, primaryExpressionPrime);}
        } else {
          jj_consume_token(-1);
          throw new ParseException();
        }
 ...
 Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3e50000,0x3e00000,0x3e00000,0x3800000,0x200000,0x3c40000,0x40000,0x0,0x0,0x3c00000,0x0,0x0,0x0,0x0,0x3c40000,0x40000,0x0,0x180000,0x40000000,0x441acf40,0x4180000,0x4180000,0x40000,0x0,0x840,0x80,0x3000,0x47dfcf40,0x4180000,0x4180000,0x700,0x4180000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4180000,0x10000000,0x10000000,0x4180000,0x4180000,0x180000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2000000,0x2000000,0x2000000,0x2000000,0x0,0x2000000,0x0,0x2,0x400,0x2000000,0x400,0x400,0x2,0x400,0x2000000,0x0,0x400,0x1c000000,0x0,0x1e102031,0x1e000000,0x1e002031,0x0,0x400,0x0,0x0,0x0,0x1e102031,0x1e002030,0x1e000000,0x0,0x1e002030,0x1000,0x800,0xc000,0xc000,0xf0000,0xf0000,0x30,0xc0,0xc0,0x200,0x1e002030,0x8,0x8,0x1c000000,0x1e002030,0x1c000000,0x2030,};
   }
